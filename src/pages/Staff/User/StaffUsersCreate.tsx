...
const StaffUsersCreate = () => {
  ...
  document.title =
    "Create Staff User | Velzon - React Admin & Dashboard Template";

  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Create Staff User" pageTitle="Staff Users" />
          <Row>
            <Col lg={12}>
              <Form
                onSubmit={(e) => {
              ...
              >
                <Card>
                  <CardHeader>
                    <h5 className="card-title mb-0">Add New Staff User</h5>
                  </CardHeader>
                  <CardBody>
                    <Row>
                      <Col md={6}>
...
export default StaffUsersCreate;
